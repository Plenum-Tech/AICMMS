...
from cafm.connectors.plugins.postgresql.type_map import map_pg_type
...
class PostgreSQLSchemaInspector(SchemaInspector):
    """Introspects PostgreSQL databases using SQLAlchemy's Inspector."""
    ...
    async def discover_table(self, table_name: str) -> TableSchema:
        ...
        for col in raw_columns:
            ...
            columns.append(
                ColumnSchema(
                    name=col["name"],
                    unified_type=map_pg_type(native_type),
