...
from sqlalchemy import MetaData, Table, create_engine, select, func, text, column as sa_column
from sqlalchemy.engine import Engine

from cafm.connectors.base import Connector, ConnectorConfig, SchemaInspector
from cafm.connectors.plugins.postgresql.schema_inspector import PostgreSQLSchemaInspector
...
class PostgreSQLConnector(Connector):
    ...
    def get_schema_inspector(self) -> SchemaInspector:
        ...
        return PostgreSQLSchemaInspector(
            engine=self._engine,
